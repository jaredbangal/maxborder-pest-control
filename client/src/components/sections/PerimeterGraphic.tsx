...
export const PerimeterGraphic = ({ className }: { className?: string }) => {
  ...
  return (
    <div ref={ref} className={className}>
      ...
      >
        <defs>
          {/* Roof reads as navy now: an orange roof vanished against the
              orange hero panel behind it. */}
        ...
        {/* Ground shadow */}
        <ellipse cx="210" cy="332" rx="120" ry="12" fill="#12203A" opacity="0.18" />
        ...
        >
          <circle cx="330" cy="100" r="30" fill="#FAF6EC" />
          <path
